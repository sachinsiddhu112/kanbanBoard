...
export default function EditTask() {
    ...
    const { loading, allTasks, updateMultipleTasksStatus, setAllTasks } = useTasks();
                    ...
                    <DragDropContext onDragEnd={onDragEndHandle}>
                        <div className='flex  flex-col  lg:flex-row min-h-[100vh] w-ful p-10  gap-[20px] justify-center'>
                            ...
                            <Droppable key="todo" droppableId={`droppabletodo`}>
                                {
                                    (droppableProvided) => (
                                        <div className='flex flex-col gap-[10px] sm:w-[250px] overflow-hidden md:w-[700px] .no-scrollbar no-scrollbar::-webkit-scrollbar  lg:h-fit lg:w-fit p-5 shadow-3xl shadow-slate-700 rounded-sm justify-center'
